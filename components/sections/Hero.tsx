        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            >
              ...
              Project kits, across every category
            </motion.p>
            ...
            >
              Every kit includes the full working app, an 8-chapter report, a
              presentation deck, and a viva question bank built for the exact
              code you&apos;re submitting — not a generic template with your
              name swapped in, and not just a zip file you&apos;re on your own
              to figure out.
            </motion.p>
